...
const Testimonials = () => {
  ...
  return (
    <div className="bg-[rgba(10,10,10,0.9)] text-white pt-20 pb-28 px-8  relative font-Roboto" id='testimonials'>
      <div className="py-20">
      <h2 className="text-3xl font-bold text-center mb-12 text-[clamp(1.6rem,2.3vw,2.5rem)] font-RobotoSlab">Testimonials</h2>
